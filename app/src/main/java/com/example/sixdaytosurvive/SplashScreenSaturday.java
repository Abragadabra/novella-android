...
public class SplashScreenSaturday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(SplashScreenSaturday.this, SixDay.class);
                SplashScreenSaturday.this.startActivity(intent);
                SplashScreenSaturday.this.finish();
