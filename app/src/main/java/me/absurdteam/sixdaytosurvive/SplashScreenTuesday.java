...
public class SplashScreenTuesday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_splash_screen_tuesday);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(SplashScreenTuesday.this, SecondDay.class);
                SplashScreenTuesday.this.startActivity(intent);
                SplashScreenTuesday.this.finish();
