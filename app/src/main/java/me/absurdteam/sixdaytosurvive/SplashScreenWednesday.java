...
public class SplashScreenWednesday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_splash_screen_wednesday);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(SplashScreenWednesday.this, ThirdDay.class);
                SplashScreenWednesday.this.startActivity(intent);
                SplashScreenWednesday.this.finish();
